...
object TrackerPreferences {
    ...
    val builtInTrackers = listOf(
        ...
        BuiltInTracker("FileBase UDP", "udp://tracker.filebase.online:6969/announce", "udp"),
        BuiltInTracker("BitSearch UDP", "udp://tracker.bitsearch.to:6969/announce", "udp"),
        BuiltInTracker("OpenTrackr HTTP", "http://tracker.opentrackr.org:1337/announce", "http"),
        BuiltInTracker("Dler HTTP", "http://tracker2.dler.org:80/announce", "http"),
        BuiltInTracker("Qu.Ax HTTP", "http://tracker.qu.ax:6969/announce", "http"),
